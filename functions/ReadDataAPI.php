...
$link5 = "https://restapiprevail-default-rtdb.firebaseio.com/status.json";
...
$dataApi5 = file_get_contents($link5, false, stream_context_create($Option));
...
$data5 = json_decode($dataApi5, true);
...
class firebaseRDB
{
    ...
    public function deleteOrder($table, $uniqueID)
    {

...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="view/nganu.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">

    <title>Previled</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <div class="container-fluid">
            <a id="cetakin" class="navbar-brand" href="#">Cetakin</a>
        ...
        <div class="row">
            <div class="col" id="element1">
                <svg width="500px" height="100vh" viewBox="0 0 541 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <img id="gambar1" src="view/gambar/book.png" alt="P">
                    <font id="tulisan">GET STARTED</font>
                </svg>
            </div>